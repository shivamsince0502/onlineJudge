package com.example.coderock.security.JwtSecurity;

import com.example.coderock.exceptions.AuthenticationFailed;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
        ...
        if (requestHeader != null && requestHeader.startsWith("Bearer")) {
            ...
            try {
                ...
                throw new MalformedJwtException("Token has changed.");
            } catch (Exception e) {
                e.printStackTrace();
            }finally {
                logger.info("Token Generation Done");
            }
        } else {
